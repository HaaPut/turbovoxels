...
#ifndef itkLevelSetMaskedEquationTermContainerBase_hxx
#define itkLevelSetMaskedEquationTermContainerBase_hxx
...
// ----------------------------------------------------------------------------
    ...
    typename LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::Iterator
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::Begin()
    {
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    typename LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::Iterator
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::End()
    {
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    typename LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::ConstIterator
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::Begin() const
    {
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    typename LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::ConstIterator
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::End() const
    {
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    void
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::AddTerm(const TermIdType & iId, TermType * iTerm)
    {
        if (iTerm)
        {
            if (!iTerm->GetInput())
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    void
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::PushTerm(TermType * iTerm)
    {
        if (iTerm)
        {
            if (!iTerm->GetInput())
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    typename LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::TermType *
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::GetTerm(const std::string & iName)
    {
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    typename LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::TermType *
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::GetTerm(const TermIdType & iId)
    {
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    void
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::Initialize(const LevelSetInputIndexType & iP)
    {
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    void
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::UpdatePixel(const LevelSetInputIndexType & iP,
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    void
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::InitializeParameters()
    {
        auto term_it = m_Container.begin();
        auto term_end = m_Container.end();
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    typename LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::LevelSetOutputRealType
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::Evaluate(const LevelSetInputIndexType & iP)
    {
        auto term_it = m_Container.begin();
        auto term_end = m_Container.end();
        ...
        if (this->m_Mask->GetPixel(iP) >= NumericTraits<SkeletonOutputType>::OneValue()) {
            return oValue;
        }
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    void
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::Update()
    {
        auto term_it = m_Container.begin();
        auto term_end = m_Container.end();
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    typename LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::LevelSetOutputRealType
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::ComputeCFLContribution() const
    {
        auto term_it = m_Container.begin();
        auto term_end = m_Container.end();
...
// ----------------------------------------------------------------------------
    template <typename TInputImage, typename TLevelSetContainer>
    void
    LevelSetMaskedEquationTermContainerBase<TInputImage, TLevelSetContainer>::ComputeRequiredData(const LevelSetInputIndexType & iP,
...
#endif // itkLevelSetMaskedEquationTermContainerBase_hxx
