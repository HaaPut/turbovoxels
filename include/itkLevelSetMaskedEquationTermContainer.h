...
#ifndef itkLevelSetMaskedEquationTermContainer_h
#define itkLevelSetMaskedEquationTermContainer_h
...
{
/**
 *  \class LevelSetMaskedEquationTermContainer
 ...
 */
    ...
    class ITK_TEMPLATE_EXPORT LevelSetMaskedEquationTermContainer : public LevelSetMaskedEquationTermContainerBase<TInputImage, LevelSetContainer<IdentifierType,LevelSetDenseImage<TInputImage>>>
    {
    public:
        //ITK_DISALLOW_COPY_AND_MOVE(LevelSetMaskedEquationTermContainer);
        using LevelSetContainerType = LevelSetContainer<IdentifierType,LevelSetDenseImage<TInputImage>>;

        using Self = LevelSetMaskedEquationTermContainer;
        ...
        itkTypeMacro(LevelSetMaskedEquationTermContainer, LevelSetMaskedEquationTerContainerBase);
        ...
        void UpdateMask() override {
            ...
            LevelSetPointer levelSet =
                (tIt->second)->GetModifiableCurrentLevelSetPointer();
            this->m_SkeletonFilter->SetInput(levelSet->GetImage());
    ...
    protected:
        LevelSetMaskedEquationTermContainer(){
            this->m_CurrentLevelSetId = LevelSetIdentifierType();
            this->m_Mask = nullptr;
            this->m_SkeletonFilter = SkeletonFilterType::New();
        }

        ~LevelSetMaskedEquationTermContainer() override = default;
    };

} // namespace itk

#endif // itkLevelSetMaskedEquationTermContainer_h
