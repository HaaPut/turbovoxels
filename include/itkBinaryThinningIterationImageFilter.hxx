 ...
 *
 *=========================================================================*/
#ifndef itkBinaryThinningIterationImageFilter_hxx
#define itkBinaryThinningIterationImageFilter_hxx
 ...
 */
    ...
    BinaryThinningIterationImageFilter<TInputImage, TOutputImage>::BinaryThinningIterationImageFilter()
    {
        this->SetNumberOfRequiredOutputs(1);

        OutputImagePointer thinImage = OutputImageType::New();
        this->SetNthOutput(0, thinImage.GetPointer());
        this->m_MaxIterations = NumericTraits<unsigned>::max();
    }
 ...
 */
    template <typename TInputImage, typename TOutputImage>
    typename BinaryThinningIterationImageFilter<TInputImage, TOutputImage>::OutputImageType *
    BinaryThinningIterationImageFilter<TInputImage, TOutputImage>::GetThinning()
    {
 ...
 */
    template <typename TInputImage, typename TOutputImage>
    void
    BinaryThinningIterationImageFilter<TInputImage, TOutputImage>::PrepareData()
    {
 ...
 */
    template <typename TInputImage, typename TOutputImage>
    double
    BinaryThinningIterationImageFilter<TInputImage, TOutputImage>::ComputeThinImage()
    {
        ...
        while (!noChange && ++currentIteration <= this->m_MaxIterations)
        {
            noChange = true;
 ...
 */
    template <typename TInputImage, typename TOutputImage>
    void
    BinaryThinningIterationImageFilter<TInputImage, TOutputImage>::GenerateData()
    {
        this->PrepareData();

        itkDebugMacro(<< "GenerateData: Computing Thinning Image");
        this->m_RemoveCount = this->ComputeThinImage();
    } // end GenerateData()
} // end namespace itk
